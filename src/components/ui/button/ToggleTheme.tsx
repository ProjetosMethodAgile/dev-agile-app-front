...
export default function ToggleTheme() {
  ...
  return (
    <button className="border-primary-300  absolute right-10 z-10 top-8 flex items-center gap-4 rounded-full border-2 border-solid p-1 *:size-8 *:cursor-pointer *:rounded-full *:p-1 *:transition-colors max-lg:mt-2 max-lg:justify-self-center">
      <Sun
        onClick={toggleTheme}
