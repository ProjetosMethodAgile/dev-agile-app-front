...
export default function FormInputText({
  ...
  return (
    <div className={twMerge("flex flex-col gap-1", className)}>
      ...
      <div
        className={twMerge(
          `focus-within:border-primary-600 hover:border-primary-600 shadow-primary-300/40 flex items-center justify-center gap-2 rounded-[12px] border-2 border-transparent bg-gray-400/50 pl-4 text-gray-50 transition-all outline-none focus-within:bg-gray-200/30 focus-within:shadow-[0px_0px_2px_2px] hover:bg-gray-200/30 hover:shadow-[0px_0px_2px_2px] active:scale-98`,
