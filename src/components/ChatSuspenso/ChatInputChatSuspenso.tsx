...
export function ChatInputChatSuspenso() {
  const { setMessageUser, messageUser, etapaAtual, motivo } =
    useGlobalContext();
  ...
  return (
    <div className="flex">
      <input
        className="flex w-full p-7 py-2 text-xl text-gray-600 outline-0 placeholder:text-xl placeholder:text-gray-600/50 dark:text-gray-100 dark:placeholder:text-gray-600"
        type="text"
        value={messageUser}
        placeholder="Digite sua mensagem"
        onChange={(e) => setMessageUser(e.target.value)}
